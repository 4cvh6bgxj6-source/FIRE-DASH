...
const LevelSelect: React.FC<Props> = ({ levels, onSelectLevel, onBack }) => {
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-4xl">
                {levels.map((level) => (
                    <div 
                        ...
                        className="group relative bg-gray-900 border border-white/10 rounded-2xl p-6 cursor-pointer hover:border-blue-500/50 transition-all transform hover:-translate-y-1 active:scale-95"
                    >
                        <div 
